...
<div class="easyui-tabs">
    <div title="Programacions Comunes">
        <div id="dlg_main" class="easyui-panel" style="width:auto;height:auto;">
            <table id="dg" class="easyui-datagrid" title="VIST I PLAU DE LES PROGRAMACIONS DIDÀCTIQUES GENERALS" style="height:auto;"
                    data-options="
                    singleSelect: true,
                    fitColumns: true,
                    pagination: false,
                    rownumbers: true,
                    toolbar: '#toolbar',
                    url: './prog_gen/prog_gen_getdata_admin.php',
                    onClickRow: getProgramacioGeneral
                    ">    
                <thead>  
                    <tr>
                        <th field="nom_document" width="200" sortable="true">Document</th>
                        <th field="Valor" width="150" sortable="true">Autor</th>
                        <th field="revisio" width="150" sortable="true">Revisat</th>
                        <th field="data_creacio" width="110" sortable="true">Data Creacio</th>
                        <th field="nom_modul" width="320" sortable="true">Mòdul</th>
                        <th field="nom_curs" width="90" sortable="true">Curs</th>
                    </tr>  
                </thead>  
            </table> 
...
<script type="text/javascript">
     ...
     */
    function afegirFuncionsMenuGestionar() {
        $("#aprovedButton").unbind();
        $("#approvedButton").bind('click', function() {
            enviarRevisio(true, <?php echo $idprofessor ?>);
        });
        
        $("#declinedButton").unbind();
        $("#declinedButton").bind('click', function() {
            enviarRevisio(false, <?php echo $idprofessor ?>);
        });
    }
    ...
    /**
     * Si el paràmetre 'aprovat' es true la programació queda aprovada. Sino, la 
     ...
     * @param {Strign} idprofessor
     */
    function enviarRevisio(aprovat, idprofessor) {
