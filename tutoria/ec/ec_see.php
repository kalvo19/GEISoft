<?php
  ...
  $rsHores    = mysql_query("select * from franges_horaries where esbarjo<>'S' order by hora_inici");   
?>
...
<div style="width:1160px;">
 <h5 style="margin-bottom:0px">
  ...
  <?= getEspaiCentre($idespais_centre)->descripcio ?></a>&nbsp;&nbsp;
 </h5>       
	<div class="left">
		&nbsp;
	</div>
				   ...
				   while($row = mysql_fetch_object($rsHores)){
					  ...
					  if ($row->esbarjo=='S') {
						...
						echo "</tr>";
						  ...
						  for ($dia=1; $dia<=5; $dia++) {
						     $rsMateries = getMateriesDiaHoraEspaiCentre($dia,$franjahoraria,$cursactual,$idespais_centre);
							 ...
							 while ($row = mysql_fetch_assoc($rsMateries)) {
								...
								echo "<div style='color:#162b48;border-bottom:1px solid #162b48;'>".$nom_professor."</div>";
								echo "</div>";
							 }
							 echo "</td>";
						  }					  
