 ...
 ?>
	...
	<div class='right'>
        ...
        <table>
        	<tr>
            	<td>
                Alumnes per sobre de percentatge (dades programació)&nbsp;
                <a style="color:#000066; font-size:16px; font-weight:bold; border:1px dashed #CCCCCC;">
                <?= $count_alum_prog ?></a>
                &nbsp;
                <a style="color:#000066; font-size:16px; font-weight:bold; border:1px dashed #CCCCCC;">
                (<?= round(($count_alum_prog/$linea)*100,2) ?>)&nbsp;%</a>
                </td>
            </tr>
            <tr>
            	<td>
                Alumnes per sobre de percentatge (dades reals)&nbsp;
                <a style="color:#000066; font-size:16px; font-weight:bold; border:1px dashed #CCCCCC;">
                <?= $count_alum_real ?></a>
                &nbsp;
                <a style="color:#000066; font-size:16px; font-weight:bold; border:1px dashed #CCCCCC;">
                (<?= round(($count_alum_real/$linea)*100,2) ?>)&nbsp;%</a>
                </td>
            </tr>
        </table>
        <br />
