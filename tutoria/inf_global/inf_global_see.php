<?php
  ...
  $txt_ca_inici = substr(getCursActual()->data_inici,8,2)."-".substr(getCursActual()->data_inici,5,2)."-".substr(getCursActual()->data_inici,0,4);
  $txt_ca_fi  = substr(getCursActual()->data_fi,8,2)."-".substr(getCursActual()->data_fi,5,2)."-".substr(getCursActual()->data_fi,0,4);
  ...
  $periode		      = getCursActual()->idperiodes_escolars;
