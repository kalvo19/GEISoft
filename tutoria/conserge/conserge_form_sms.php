<div class="easyui-panel" title="SMS" style="padding-left:30px;width:505px; height:460px; filter:alpha(opacity=75);-moz-opacity:.75;opacity:.75;">
...
<textarea readonly class="easyui-validatebox" name="destinataris" id="destinataris" class="form-text" rows="8" cols="50">
</textarea>
